  ...
  objects: [
    {
      ...
      description: "Бутик-промтехнопарк класса A+ в Митино для light industrial, офиса, showroom, общепита и смешанных бизнес-сценариев. Доступен только в аренду: 7 помещений и сценарий объединения в единый контур.",
      metrics: [
