  ...
  function renderObjectPage() {
    ...
    if (id === "mitino") {
      ...
      const mitinoInfrastructure = [
        ["assets/mitino-long-term-lease.png", "Долгосрочная аренда", "Согласование улучшений, понятная экономика и возможность настроить помещение под процесс арендатора."],
        ["assets/mitino-planning.png", "Функциональная планировка", "Производство, мезонины, офисы, showroom и общепит можно собирать в рабочие сценарии без лишних дублей."],
        ["assets/mitino-infrastructure.png", "Инфраструктура для команды", "Коворкинг, showroom, кафе, фитнес-зона, падел-корт, зеленая веранда и зарядные станции."],
        ["assets/mitino-infrastructure.svg", "Объединение функций", "Объект подходит компаниям, которым нужно разместить производство, инженерный офис и клиентскую зону в одном адресе."]
      ];
    ...
    if (id === "grekova") {
      const grekovaKpis = [
        ...
        ["РНС август 2026", "ключевая дата проекта"]
      ];
      ...
      const grekovaRoadmap = [
        ...
        ["08.2026", "РНС", "Ключевая дата: получение разрешения на строительство."],
      ...
      target.innerHTML = `
        <section class="object-hero section-dark grekova-hero">
          ...
          <div class="object-hero-content">
            ...
            <div class="hero-labels"><span>3 695,89 м²</span><span>2 619,78 м² арендуемые</span><span>РНС август 2026</span><span>метро 290 м</span></div>
            <div class="hero-actions">
